...
func autoConvert_v1_Device_To_api_Device(in *Device, out *api.Device, s conversion.Scope) error {
	out.Kind = in.Kind
	out.Name = in.Name
...
func autoConvert_api_Device_To_v1_Device(in *api.Device, out *Device, s conversion.Scope) error {
	out.Kind = in.Kind
	out.Name = in.Name
	out.Properties = *(*map[string]string)(unsafe.Pointer(&in.Properties))
	return nil
...
func autoConvert_v1_NodeStatus_To_api_NodeStatus(in *NodeStatus, out *api.NodeStatus, s conversion.Scope) error {
	out.Capacity = *(*api.ResourceList)(unsafe.Pointer(&in.Capacity))
	out.DevCapacity = *(*[]api.Device)(unsafe.Pointer(&in.DevCapacity))
	out.Allocatable = *(*api.ResourceList)(unsafe.Pointer(&in.Allocatable))
	out.DevAvailable = *(*[]api.Device)(unsafe.Pointer(&in.DevAvailable))
...
func autoConvert_api_NodeStatus_To_v1_NodeStatus(in *api.NodeStatus, out *NodeStatus, s conversion.Scope) error {
	out.Capacity = *(*ResourceList)(unsafe.Pointer(&in.Capacity))
	out.DevCapacity = *(*[]Device)(unsafe.Pointer(&in.DevCapacity))
	out.Allocatable = *(*ResourceList)(unsafe.Pointer(&in.Allocatable))
	out.DevAvailable = *(*[]Device)(unsafe.Pointer(&in.DevAvailable))
