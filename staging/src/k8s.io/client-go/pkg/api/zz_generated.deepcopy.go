...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_api_Device, InType: reflect.TypeOf(&Device{})},
...
// DeepCopy_api_Device is an autogenerated deepcopy function.
func DeepCopy_api_Device(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*Device)
		out := out.(*Device)
		*out = *in
...
func DeepCopy_api_NodeStatus(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		*out = *in
		...
		if in.DevCapacity != nil {
			in, out := &in.DevCapacity, &out.DevCapacity
			*out = make([]Device, len(*in))
			for i := range *in {
				if err := DeepCopy_api_Device(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
		...
		if in.DevAvailable != nil {
			in, out := &in.DevAvailable, &out.DevAvailable
			*out = make([]Device, len(*in))
			for i := range *in {
				if err := DeepCopy_api_Device(&(*in)[i], &(*out)[i], c); err != nil {
					return err
