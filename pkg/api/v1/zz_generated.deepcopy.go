...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1_Device, InType: reflect.TypeOf(&Device{})},
...
// DeepCopy_v1_Device is an autogenerated deepcopy function.
func DeepCopy_v1_Device(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*Device)
		out := out.(*Device)
		*out = *in
		...
		*out = *in
		...
		if in.DevCapacity != nil {
			...
			*out = make([]Device, len(*in))
			for i := range *in {
				if err := DeepCopy_v1_Device(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
